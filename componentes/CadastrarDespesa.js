    ...
    return <View style={{ marginTop: 30, flex: 1 }}>
        ...
        <View style={{ top: 0 }}>
            <View style={styles.viewAdjacente}>
                ...
                <Text style={{ backgroundColor: Colors.verdePrincipal, paddingHorizontal: 5, color: Colors.branco, fontSize: 16, paddingVertical: 1, marginVertical: 6, width: 80 }}>X Salário</Text>

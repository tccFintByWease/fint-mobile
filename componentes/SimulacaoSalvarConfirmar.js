...
function SimulacaoSalvarConfirmar() {
    return (
        <View style={{ flex: 1, paddingHorizontal: 20, paddingVertical: 30, width: '80%' }}>
            <View style={{ alignItems: 'center' }}>
                <Text style={styles.textoCima}>
                    Deseja Savar essa simulação?
                </Text>
            </View>
            <View>
                <BotaoInicio styleExterno={styles.botaoExterno} styleCorpo={styles.botaoInterno} styleTexto={patternStyle.textoBotao}>Confirmar</BotaoInicio>
...
export default SimulacaoSalvarConfirmar;